...
class SpamFilter():
    ...
    def main():
        # initialise the data
        spam = SpamFilter.init_lists('/home/debugger2017/Demo/SpamFiltering/mail_system/enron1/spam/')
        ham = SpamFilter.init_lists('/home/debugger2017/Demo/SpamFiltering/mail_system/enron1/ham/')
